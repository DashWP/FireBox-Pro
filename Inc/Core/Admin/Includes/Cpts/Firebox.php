...
class Firebox extends Cpt
{
	...
	public function after_save($fields, $post_id, $cpt)
	{
		...
		$display_conditions_type = isset($fields['display_conditions_type']) ? $fields['display_conditions_type'] : false;
		if ($display_conditions_type !== 'custom')
		{
			return $fields;
		}

		\FPFramework\Base\Conditions\ConditionsHelper::getInstance()->onBeforeSave($fields['rules']);
	...
	private function initDependencies()
	{
		...
		new FireBox\FloatingButtonTriggerEditor();
