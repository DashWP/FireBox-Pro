			...
			'content' => [
				...
				'behavior' => [
					...
					'fields' => [
						...
						[
							'name' => 'close_out_viewport',
							'type' => 'FPToggle',
							'label' => firebox()->_('FB_METABOX_CLOSE_OUT_VIEWPORT'),
							'description' => firebox()->_('FB_METABOX_CLOSE_OUT_VIEWPORT_DESC'),
							'showon' => '[triggermethod]:element'
						],
						[
							'name' => 'scroll_depth',
							'type' => 'Toggle',
							'label' => firebox()->_('FB_METABOX_SCROLL_DEPTH'),
							'description' => firebox()->_('FB_METABOX_SCROLL_DEPTH_DESC'),
							'default' => 'percentage',
							'choices' => [
								'percentage' => 'FPF_PERCENTAGE',
								'pixel' => 'FPF_PIXEL'
							],
						...
						[
							...
							'type' => 'Slider',
							'label' => firebox()->_('FB_METABOX_TRIGGER_PERCENTAGE'),
							'description' => firebox()->_('FB_METABOX_TRIGGER_PERCENTAGE_DESC'),
							'default' => 80,
							'min' => 0,
							'max' => 100,
							'step' => 10,
						...
						[
							'name' => 'scroll_pixel',
							'type' => 'Slider',
							'label' => firebox()->_('FB_METABOX_TRIGGER_PIXEL'),
							'description' => firebox()->_('FB_METABOX_TRIGGER_PIXEL_DESC'),
							'default' => 100,
							'min' => 0,
							'max' => 10000,
							'step' => 100,
						...
						[
							'name' => 'exittimer',
							'type' => 'Slider',
							'label' => firebox()->_('FB_METABOX_EXIT_TIMER'),
							'description' => firebox()->_('FB_METABOX_EXIT_TIMER_DESC'),
							'default' => 1,
							'min' => 0,
							'max' => 120,
							'step' => 2,
						...
						[
							'name' => 'autohide',
							'type' => 'FPToggle',
							'label' => firebox()->_('FB_METABOX_CLOSE_RVRS_SCROLL'),
							'description' => firebox()->_('FB_METABOX_CLOSE_RVRS_SCROLL_DESC'),
							'showon' => '[triggermethod]:pageheight'
						],
						[
							'name' => 'firing_frequency',
							'type' => 'Toggle',
							'label' => firebox()->_('FB_METABOX_FIRING_FREQUENCY'),
							'description' => firebox()->_('FB_METABOX_FIRING_FREQUENCY_DESC'),
							'default' => 1,
							'choices' => [
								'1' => firebox()->_('FB_METABOX_ONCE_PER_PAGE'),
								'2' => 'FPF_UNLIMITED'
							],
						...
						[
							'name' => 'threshold',
							'type' => 'Slider',
							'label' => firebox()->_('FB_METABOX_THRESHOLD'),
							'description' => firebox()->_('FB_METABOX_THRESHOLD_DESC'),
							'min' => 0,
							'default' => 25,
							'addon' => '%',
							'showon' => '[triggermethod]:element'
						...
						[
							...
							'description' => firebox()->_('FB_METABOX_TRIGGER_DELAY_DESC'),
						...
						[
							'name' => 'idle_time',
							'type' => 'Slider',
							'label' => firebox()->_('FB_METABOX_IDLE_TIME'),
							'description' => firebox()->_('FB_METABOX_IDLE_TIME_DESC'),
							'default' => 10,
							'min' => 1,
							'max' => 120,
							'step' => 2,
						...
						[
							'name' => 'floating_button_show_on_close',
							'type' => 'FPToggle',
							'label' => firebox()->_('FB_FLOATING_BUTTON_SHOW_ON_CLOSE'),
							'description' => firebox()->_('FB_FLOATING_BUTTON_SHOW_ON_CLOSE_DESC'),
							'showon' => '[triggermethod]!:onexternallink,floatingbutton'
						],
						[
							'name' => 'floating_button_message',
							'type' => 'Link',
							'href' => '#',
							'title' => firebox()->_('FB_EDIT_MESSAGE'),
							'label' => firebox()->_('FB_FLOATING_BUTTON_MESSAGE'),
							'description' => firebox()->_('FB_FLOATING_BUTTON_MESSAGE_DESC'),
							'showon' => '[floating_button_show_on_close]:1[OR][triggermethod]:floatingbutton',
							'input_class' => ['fpf-button', 'primary', 'fpf-modal-opener'],
							'extra_atts' => [
								'data-fpf-modal' => '#fpf-floating-button-trigger-form-modal'
							]
						],
						[
							'name' => 'floating_button_position',
							'type' => 'Dropdown',
							'label' => firebox()->_('FB_FLOATING_BUTTON_POSITION'),
							'description' => firebox()->_('FB_FLOATING_BUTTON_POSITION_DESC'),
				...
				'opening_behavior' => [
					...
					'fields' => [
						...
						[
							'name' => 'assign_impressions_param_type',
							'type' => 'Dropdown',
							...
							'input_class' => ['medium'],
							'choices' => [
								'always' => 'FPF_EVERY_TIME_PAGE_LOADS',
								'session' => 'FPF_ONCE_PER_SESSION',
								'day' => 'FPF_ONCE_PER_DAY',
								'week' => 'FPF_ONCE_PER_WEEK',
								'custom' => 'FPF_CUSTOM'
							]
						],
						[
							...
							'showon' => '[assign_impressions_param_type]:custom'
						],
						[
							'type' => 'CustomDiv',
						...
						[
							'type' => 'Number',
							'input_class' => ['xsmall'],
							'name' => 'assign_impressions_param_custom_period_times',
							'default' => 1,
							'min' => 1,
							'render_group' => false
						],
						[
							'type' => 'Label',
							'text' => 'FPF_TIMES_PER',
							'input_class' => ['text-lowercase'],
							'render_group' => false
						],
						[
							'name' => 'assign_impressions_param_custom_period',
							'type' => 'Dropdown',
							'render_group' => false,
							'input_class' => ['small'],
							'default' => 'session',
				...
				'closing_behavior' => [
					...
					'fields' => [
						...
						[
							'type' => 'Label',
							'label' => firebox()->_('FB_AUTO_CLOSE_CAMPAIGN'),
							'description' => firebox()->_('FB_AUTO_CLOSE_CAMPAIGN_DESC'),
						...
						[
							...
							'render_group' => false,
							'choices' => [
								'yes' => firebox()->_('FB_AUTO_CLOSE_CAMPAIGN_AFTER')
							]
						],
						[
							'type' => 'Number',
							'name' => 'box_auto_close_seconds',
							'input_class' => ['xsmall'],
							'default' => 5,
							'min' => 1,
							'render_group' => false
				...
				'accessibility' => [
					...
					'fields' => [
						...
						[
							'name' => 'close_on_esc',
							'type' => 'FPToggle',
							'label' => firebox()->_('FB_CLOSE_ON_ESC'),
							'description' => firebox()->_('FB_CLOSE_ON_ESC_DESC')
						],
				...
				'floatingbutton' => [
					...
					'fields' => [
						[
							'name' => 'floatingbutton_message.text',
							'type' => 'Text',
							'label' => fpframework()->_('FPF_TEXT'),
							'description' => firebox()->_('FB_FLOATING_BUTTON_MESSAGE_TEXT'),
							'input_class' => ['fullwidth'],
							'default' => 'Your message here'
						],
						[
							'name' => 'floatingbutton_message.bgcolor',
							'type' => 'Color',
							'label' => fpframework()->_('FPF_BACKGROUND_COLOR'),
							'description' => firebox()->_('FB_FLOATING_BUTTON_MESSAGE_TEXT_BG_DESC'),
							'default' => '#4285F4',
							'input_class' => ['fullwidth']
						],
						[
							'name' => 'floatingbutton_message.textcolor',
							'type' => 'Color',
							'label' => fpframework()->_('FPF_TEXT_COLOR'),
							'description' => firebox()->_('FB_FLOATING_BUTTON_MESSAGE_TEXT_COLOR'),
							'default' => '#ffffff',
							'input_class' => ['fullwidth']
						],
						[
							'name' => 'floatingbutton_message.fontsize',
							'type' => 'Number',
							'label' => fpframework()->_('FPF_FONT_SIZE'),
							'description' => firebox()->_('FB_FLOATING_BUTTON_MESSAGE_TEXT_SIZE'),
							'default' => 16,
							'addon' => 'px',
							'input_class' => ['fullwidth']
						]
