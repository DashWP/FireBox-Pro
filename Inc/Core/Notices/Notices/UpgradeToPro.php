...
class UpgradeToPro extends Notice
{
	...
	protected function getActions()
	{
		...
		return '<a href="' . esc_url(\FPFramework\Base\Functions::getUTMURL($url, 'wordpress', 'UserNotice', 'UpgradeToPro')) . '" target="_blank" class="firebox-notice-btn error">' . esc_html($label) . '</a>';
	}
