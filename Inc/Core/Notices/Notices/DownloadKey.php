...
class DownloadKey extends Notice
{
	...
	{
		$url = 'https://www.fireplugins.com/docs/firebox/first-steps/how-to-activate-firebox-pro/';
		$url = \FPFramework\Base\Functions::getUTMURL($url, 'wordpress', 'UserNotice', 'DownloadKey') . '#find_license_key';
