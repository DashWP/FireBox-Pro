...
class Expired extends Notice
{
	...
	protected function getActions()
	{
		...
		return '<a href="' . esc_urL(Functions::getUTMURL($url, 'wordpress', 'UserNotice', 'SubscriptionExpired')) . '" target="_blank" class="firebox-notice-btn">' . esc_html(sprintf(firebox()->_('FB_REACTIVATE_X_PERCENT_OFF'), 20)) . '</a>';
	}
