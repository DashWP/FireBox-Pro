...
class Geolocation extends Notice
{
	...
	{
		$geolocationDocsUrl = 'https://www.fireplugins.com/docs/firebox/start/first-steps/how-to-enable-geolocation-features/';
		$url = Functions::getUTMURL($geolocationDocsUrl, 'wordpress', 'UserNotice', 'Geolocation');
