...
';
wp_add_inline_script('firebox', html_entity_decode(stripslashes($js)));
...
?>
<div class="<?php esc_attr_e(implode(' ' , $cssClasses)); ?>">
	<div data-fbox="<?php esc_attr_e($box->get('ID')); ?>" data-fbox-delay="0"><?php echo wp_kses($box->get('params.data.floatingbutton_message.text', ''), $allowed_html); ?></div>
</div>