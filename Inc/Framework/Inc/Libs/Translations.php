...
class Translations
{
	...
	public static function getTranslations()
	{
		return [
			...
			'FPF_GEOIP_LOOKUP_DESC' => __('Test drive the Geolocation services by looking up an IP address.', 'fpf-framework'),
			...
			'FPF_UNLOCK_PRO_FEATURE' => __('Unlock Pro Feature', 'fpf-framework'),
