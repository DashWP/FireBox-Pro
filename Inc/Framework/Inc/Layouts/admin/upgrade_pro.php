...
<div class="pro-only-body text-center">
    ...
    <p>
        <a class="fpf-button upgrade large" data-href="<?php echo esc_url(FPF_SITE_URL); ?>{{PLUGIN_SLUG}}/upgrade?coupon=FREE2PRO&amp;utm_source=Wordpress&amp;utm_medium=upgradebutton&amp;utm_campaign=freeversion" href="#" target="_blank">
    ...
    <div class="pro-only-footer">
        <div data-text="<?php echo htmlentities(wp_kses(sprintf(fpframework()->_('FPF_PRO_MODAL_PRESALES_QUESTIONS'), esc_url(FPF_SUPPORT_URL) . '?topic=Pre-sale Question'), $allowed_tags)); ?>"></div>
